...
class HeaterBuilder
{
    ...
    private void CreateTube(int index,HeaterLine heater_line,double outer_D,double innner_D,double Z)
    {
        ...
        NXFunction.MoveBodyByIncrement("TUBE-" + index.ToString(),0,0,Z);
    }

////属性
//void SaveCode2Tube(int curve_index, double length)
//{
//    Session* theSession = Session.GetSession;
//    Part* workPart(theSession.Parts.Work);

//    string name_part = "TUBE-" + std.to_string((double)curve_index);
//    string code = "42201";
//    double error = 2;
...
//    NXFunction.SetAttribute(name_part, "基本参数", "name", "M" + std.to_string((double)(curve_index)));
...
////生成上层陶瓷接线盒，并和管道合并
//void CreateBox(int curve_index,
//                        Vector3d dir,
